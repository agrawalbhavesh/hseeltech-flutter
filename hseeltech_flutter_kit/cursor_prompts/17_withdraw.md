# Withdraw Screen - Cursor Migration Prompt

## Screenshot Reference
`@file:assets/images/screenshots/withdraw.png`
...
## Current Code
```
@file:lib/features/wallet/screens/withdraw_screen.dart
```
...
Migrate the **Withdraw Screen** to match the new Hseeltech design shown in the screenshot.

**CURRENT CODE:**
@file:lib/features/wallet/screens/withdraw_screen.dart

DESIGN SPECIFICATIONS:
- Header "سحب" with back button
- Available balance display
- Amount input (large, centered)
- "سحب الكل" quick button
