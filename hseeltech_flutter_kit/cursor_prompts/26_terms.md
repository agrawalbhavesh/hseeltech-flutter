# Terms & Conditions - Cursor Migration Prompt

## Screenshot Reference
`@file:assets/images/screenshots/terms.png`
...
## Current Code
```
@file:lib/features/legal/screens/terms_screen.dart
```
...
Migrate the **Terms & Conditions** to match the new Hseeltech design shown in the screenshot.

**CURRENT CODE:**
@file:lib/features/legal/screens/terms_screen.dart

DESIGN SPECIFICATIONS:
- Header "الشروط والأحكام" with back button
- Scrollable rich text content
- Section headers in HseelTypography.h3
- Body text in HseelTypography.body
...
- [ ] Terms content from API/CMS (not hardcoded)
- [ ] Version tracking
